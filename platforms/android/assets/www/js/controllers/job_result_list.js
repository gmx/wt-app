    ...
    switch (data.loadPage) {
      case 'job_search_by_city':
        $.ajax({
          ...
          url: baseUrl + '/api/cities/' + data.id + '/jobs',
      ...
      case 'job_search_by_type':
        $.ajax({
          ...
          url: baseUrl + '/api/job_types/' + data.id + '/jobs',
          success: function(apiData) {
            $list = $(page).find('.job-result-list');
            if (apiData.data.length > 0) {
              for (var i in apiData.data) {
      ...
      case 'job_search_by_category':
        $.ajax({
          ...
          url: baseUrl + '/api/categories/' + data.id + '/jobs',
          success: function(apiData) {
            $list = $(page).find('.job-result-list');
            if (apiData.data.length > 0) {
              for (var i in apiData.data) {
      ...
      case 'query_search':
        $.ajax({
          ...
          url: baseUrl + '/api/search/jobs?query=' + data.query,
          success: function(apiData) {
            $list = $(page).find('.job-result-list');
            if (apiData.data.length > 0) {
              for (var i in apiData.data) {
